...
var textStrings = [
    "Nice to meet you, $user! The EMDR treatment is designed to help you move forward from memories that hold you back. I know this is hard, but for this to work, you'll have to relive that experience and tell me about it. Tell me what happened when you're ready.",
    "How did you feel about that?",
    "That sounds tough... Let's talk about it another way. What positive traits do you think you displayed in that situation?",
    "You're doing great, $user! Why don't you reframe the whole situation? Describe yourself positively! No negative thoughts now. :)",
    "Great! Now focus on that positive description. After you hit ENTER again, you'll see a black screen with a bright dot. Focus on the dot while thinking about that positive description, okay $user?",
    "Here we go!"
];
var stringIndex = 0;
