...
var textStrings = [
    ...
    "Good! Now try reframing the whole situation, $user. Describe the situation again, but this time only describing yourself positively!",
    "That's great, $user! Now, we can do this again (respond \"Again\") or we can proceed to the EMDR part of the treatment (respond \"I'm ready\"). Either one is okay, take your time deciding, okay?",
